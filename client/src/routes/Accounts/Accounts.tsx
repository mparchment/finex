...
export default function Accounts() {
  const accounts = [
    { name: "Checking Acocunt", type: "Checking", number: "132631525", balance: 10817.32 },
  ...
  const handleAccountClick = (account: any) => {
    // Placeholder function to be called when an AccountPreview component is clicked
    console.log(`Clicked account: ${account.number}`);
  }
